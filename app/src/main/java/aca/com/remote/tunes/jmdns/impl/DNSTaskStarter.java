 ...
 *
 */
package aca.com.remote.tunes.jmdns.impl;

import android.util.Log;

import aca.com.remote.tunes.jmdns.impl.tasks.RecordReaper;
import aca.com.remote.tunes.jmdns.impl.tasks.Responder;
import aca.com.remote.tunes.jmdns.impl.tasks.resolver.ServiceInfoResolver;
import aca.com.remote.tunes.jmdns.impl.tasks.resolver.ServiceResolver;
import aca.com.remote.tunes.jmdns.impl.tasks.resolver.TypeResolver;
import aca.com.remote.tunes.jmdns.impl.tasks.state.Announcer;
import aca.com.remote.tunes.jmdns.impl.tasks.state.Canceler;
import aca.com.remote.tunes.jmdns.impl.tasks.state.Prober;
import aca.com.remote.tunes.jmdns.impl.tasks.state.Renewer;
...
public interface DNSTaskStarter {
    ...
    public static final class DNSTaskStarterImpl implements DNSTaskStarter {
        ...
        public void startServiceResolver(String type) {
            ServiceResolver service = new ServiceResolver(_jmDNSImpl, type);
            service.start(_timer, 6);
        }
